          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(widget.list.resource!.title.toString(),
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  const SizedBox(height: 20.0,),
                  widget.list.resource!.embedUrlId != null
                      ? SizedBox(
                          height: 200.0,
                          child: VimeoPlayer(
                                videoId: widget.list.resource!.embedUrlId!, //widget.list!.sId!,
                          ),
                        )
                      : Container(
                          height: 200.0,
                  ...
                  const SizedBox(height: 20.0,),
                  Text(
                    widget.list.resource!.title.toString(),
                    style: Style.textStyleBold15,
                  ),
                  const SizedBox(height: 10.0,),
                  Text(widget.list.resource!.description.toString(),
                    style: Style.textStyleRegular13Black,
                  ),
                  const SizedBox(height: 10.0,),
                  Style.divider(),
                  const SizedBox(height: 10.0,),
                  Text("Comments",style: Style.textStyleBold15,),
                  Container(
                    ...
                    child: TextButton.icon(
                        onPressed: () {
                          bottomSheet(widget.list.resource!);
                        },
                        icon: const Icon(
                          Icons.comment,
